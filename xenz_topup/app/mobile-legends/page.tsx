    ...
    <div className="min-h-screen flex flex-col bg-gray-50 text-gray-800">
      ...
      <main className="flex-grow px-6 py-12 text-center">
        ...
        <p className="text-gray-600 mb-8">
          Cepat, aman, dan terpercaya. Pilih paket top-up Anda untuk Mobile Legends dan nikmati permainan tanpa batas!
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[{ amount: "50 Diamonds", price: "Rp 10.000" }, { amount: "100 Diamonds", price: "Rp 20.000" }, { amount: "500 Diamonds", price: "Rp 100.000" }].map((packageItem, index) => (
            <div
              key={index}
